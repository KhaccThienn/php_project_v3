...
$category_search = isset($_GET['name']) ? $_GET['name'] : '';
...
<section class="content">
  ...
  <div class="box-header">
    ...
    <form class="form-group" method="GET" action="category/search.php">
        ...
        <?php if ($result->num_rows > 0) { ?>
          <?php foreach ($result as $key => $value) { ?>
            <tr>
              ...
              <td>
                <a href="?page=category/update.php&id=<?= $value['id'] ?>" class="btn btn-success">Update</a>
                <a href="?page=category/delete.php&id=<?= $value['id'] ?>" class="btn btn-danger" onclick='return confirm("Are You Sure About That ? All Products which have this category  will be delete ! ")'>Delete</a>
              </td>
            </tr>
